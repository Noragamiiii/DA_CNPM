...
public class Dashboard extends JFrame {
    ...
    private void initComponents() {
        ...
        btnExit.setIcon(new ImageIcon(getClass().getResource("/gambar/Exit.png"))); // NOI18N
        btnExit.setContentAreaFilled(false);
        btnExit.setFocusable(false);
        btnExit.setOpaque(true);
        btnExit.setRolloverIcon(new ImageIcon(getClass().getResource("/gambar/Exit (2).png"))); // NOI18N
        ...
        btnMaximize.setIcon(new ImageIcon(getClass().getResource("/Gambar/Maximize.png"))); // NOI18N
        btnMaximize.setContentAreaFilled(false);
        btnMaximize.setFocusable(false);
        btnMaximize.setOpaque(true);
        btnMaximize.setRolloverIcon(new ImageIcon(getClass().getResource("/Gambar/Maximize (2).png"))); // NOI18N
        ...
        btnMinimize.setRolloverIcon(new ImageIcon(getClass().getResource("/gambar/Minimize (2).png"))); // NOI18N
       ...
       GroupLayout pnlHeaderLayout = new GroupLayout(pnlHeader);
        ...
        btnTimeline.setFont(new Font("Arial", Font.BOLD, 16)); // NOI18N
        ...
        btnNews.setFont(new Font("Arial", Font.BOLD, 16)); // NOI18N
        ...
        JLabel lblfullname = new JLabel("TÊN HỘ DÂN: ");
        	...
        	pnlMenuLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(pnlMenuLayout.createSequentialGroup()
        			...
        			.addGroup(pnlMenuLayout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(Alignment.LEADING, pnlMenuLayout.createSequentialGroup()
        		...
        		.addGroup(pnlMenuLayout.createSequentialGroup()
        			.addGroup(pnlMenuLayout.createParallelGroup(Alignment.TRAILING)
        				...
        				.addGroup(Alignment.LEADING, pnlMenuLayout.createSequentialGroup()
        					.addGap(12)
        					.addGroup(pnlMenuLayout.createParallelGroup(Alignment.TRAILING)
        						.addComponent(fullname, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE)
        						.addComponent(lblfullname))))
        ...
        jPanel1Layout.setHorizontalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        		...
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			.addGap(10)
        			.addComponent(jLabel12, GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE))
        );
        ...
        label_1 = new JLabel();
        label_1.setIcon(new ImageIcon("E:\\tiu\\icon\\vaccine (1).png"));
        ...
        jLabel8.setFont(new Font("Segoe UI", Font.BOLD, 14)); // NOI18N
        ...
        jLabel13.setIcon(new ImageIcon("E:\\tiu\\icon\\calendar (1).png")); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
        	jPanel4Layout.createParallelGroup(Alignment.TRAILING)
        		...
        		.addGroup(Alignment.LEADING, jPanel4Layout.createSequentialGroup()
        			.addGap(19)
        			.addComponent(lblNewLabel, GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
        			.addGap(24))
        );
        ...
        pnlNewsLayout.setHorizontalGroup(
        	pnlNewsLayout.createParallelGroup(Alignment.TRAILING)
        		.addComponent(jspNews, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE)
        );
        pnlNewsLayout.setVerticalGroup(
        	pnlNewsLayout.createParallelGroup(Alignment.LEADING)
        		.addComponent(jspNews, GroupLayout.DEFAULT_SIZE, 440, Short.MAX_VALUE)
        );
        ...
        gl_panel.setHorizontalGroup(
        	gl_panel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_panel.createSequentialGroup()
        			.addGap(41)
        			.addComponent(separator, GroupLayout.DEFAULT_SIZE, 947, Short.MAX_VALUE)
        			.addContainerGap())
        );
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(pnlMenu, GroupLayout.PREFERRED_SIZE, 123, GroupLayout.PREFERRED_SIZE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(pnlBody, GroupLayout.DEFAULT_SIZE, 466, Short.MAX_VALUE))
        );
